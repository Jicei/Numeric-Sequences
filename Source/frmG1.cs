...
namespace Меню
{
    public partial class frmG1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            label10.Text=Convert.ToString("Площа усіх квадратів -  "+Math. Round(S,2));
        ...
        {
            frmG1_2 thirt_form = new frmG1_2();
            thirt_form.StartPosition = FormStartPosition.CenterScreen;
            thirt_form.Show();
        }

        private void frmG1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
